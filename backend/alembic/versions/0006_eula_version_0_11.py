"""seed eula version 0.11

Revision ID: 2385931d5a57
...
revision = "2385931d5a57"
down_revision = "f7a8b9c0d1e2"
branch_labels = None
depends_on = None

_BODY_HTML = """<p style="color:#888;font-style:italic;margin-bottom:1rem">Version 0.11</p>
...
def upgrade() -> None:
    op.execute(
        sa.text(
            ...
            effective_date='2026-05-08T04:59:00+00:00',
        )
    )

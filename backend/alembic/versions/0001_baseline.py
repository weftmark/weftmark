"""Schema baseline — squash of migrations 0001-0032.

Includes eula_versions seed data (v0.3, v0.5, v0.9).
Revision ID: 11f6119b07a0
Revises:
Create Date: 2026-05-02 18:14:50.864906
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_loom_version_accessories_loom_version_id"),
        "loom_version_accessories",
        ["loom_version_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_loom_version_photos_loom_version_id"), "loom_version_photos", ["loom_version_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_loom_version_receipts_loom_version_id"), "loom_version_receipts", ["loom_version_id"], unique=False
    )
    op.create_table(
        "activity_photos",
        sa.Column("id", sa.UUID(), nullable=False),

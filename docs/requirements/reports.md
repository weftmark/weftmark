...
- **On-screen view** — rendered in the browser, navigable by section
- **PDF export** — generated server-side as a background job; user is notified when ready for download
